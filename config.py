...
parser = argparse.ArgumentParser(description='DS3Gym Framework')
...
parser.add_argument('--scheduler_name', type=str, default='met', help='Scheduler name (etf/met/stf/heftrt/random/deepsocs)')
...
# RL common
parser.add_argument('--run_mode', type=str, default='step', help='running mode (run/step)')
...
parser.add_argument('--learn_obj', type=str, default='duration', help='learning objective (duration/makespan/latency)')
